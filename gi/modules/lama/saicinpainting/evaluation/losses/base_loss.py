...
from gi.modules.lama.models.ade20k import SegmentationModule, NUM_CLASS, segm_options
...
class PairwiseScore(EvaluatorScore, ABC):
    ...
    def get_value(self, groups=None, states=None):
        ...
        """
        individual_values = torch.cat(states, dim=0).reshape(-1).cpu().numpy() if states is not None \
